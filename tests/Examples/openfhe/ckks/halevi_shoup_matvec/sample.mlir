// -----// IR Dump After LayoutOptimization (layout-optimization) //----- //
#alignment = #tensor_ext.alignment<in = [16, 16], out = [16, 16]>
#layout = #tensor_ext.layout<map = (d0) -> (d0 mod 16)>
#layout1 = #tensor_ext.layout<map = (d0, d1) -> (d1 mod 16, (d0 + d1) mod 16), alignment = #alignment>
module attributes {backend.openfhe, scheme.ckks} {
  func.func @matvec(%arg0: !secret.secret<tensor<16xf32>> {tensor_ext.layout = #layout}) -> (!secret.secret<tensor<16xf32>> {tensor_ext.layout = #layout}) {
    ...
    %0 = secret.generic ins(%arg0 : !secret.secret<tensor<16xf32>>) attrs = {__argattrs = [{tensor_ext.layout = #layout}], tensor_ext.layout = #layout} {
